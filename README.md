...
# **Quarentine Project #0** - Ajuste automático de brilho de acordo com a iluminação externa.
...
# **Quarentine Project #1** - Jogo da Forca e Joga da Velha.
...
# **Quarentine Project #2** - Página simples para passar mensagem clara durante a pandemia.
...
# **Quarentine Project #3** - Controle de caixa de um jogo de tabuleiro.
...
# **Quarentine Project #4** - Extensão para o Google Chrome.
...
# **Quarentine Project #5** - Urna eletrônica criada em 2014.
...
# **Quarentine Project #6** - Criação de emblemas simples personalizados para o repositório.
